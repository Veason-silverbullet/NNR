...
def dev(config: Config, mind_corpus: MIND_Corpus):
    ...
    auc, mrr, ndcg5, ndcg10 = compute_scores(model, mind_corpus, config.batch_size * 2, 'dev', dev_res_dir + '/' + model.model_name + '.txt', config.dataset)
...
def test(config: Config, mind_corpus: MIND_Corpus):
    ...
    auc, mrr, ndcg5, ndcg10 = compute_scores(model, mind_corpus, config.batch_size * 2, 'test', test_res_dir + '/' + model.model_name + '.txt', config.dataset)
